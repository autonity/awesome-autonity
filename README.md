...
_This list is maintined by the Autonity Community purely as an informational resource. It is curated **only** in the sense of containing things that Autonity community members liked or found useful when they saw it. Inclusion in this list does not imply endorsement and constitutes neither implicit nor explicit warranties or guarantees in relation to any of the products, resources, projects, entities, views, opinions, or sources listed here. **Do not rely** on anything here. Autonity shall not be liable for any damages or losses arising from the use of this repository or any information provided or linked to here._
...
- [Telegram](https://t.me/+Tlfj9xgfHtg1ZTI8)
...
- [Decentralized Derivatives Clearing](https://medium.com/autonity/decentralised-derivatives-clearing-part-1-8ffebd0bd227) (by [Autonity](https://medium.com/autonity))
...
- [Autonity Oracle Server](https://github.com/autonity/autonity-oracle)
...
- Public endpoints. Publicly accessible node endpoints (RPC, WebSocket, GraphQL):
  - [Bakerloo Testnet](https://docs.autonity.org/networks/testnet-bakerloo/#public-endpoints)
  - [Mainnet](https://docs.autonity.org/networks/testnet-piccadilly/#public-endpoints)
- [SubQuery Indexer integration](https://subquery.network/doc/indexer/quickstart/quickstart_chains/autonity.html)
